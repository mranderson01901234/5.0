...
const clerkAppearance = {
  ...
  elements: {
    ...
    card: "bg-[#0f0f0f] border border-white/10 shadow-2xl p-8 rounded-2xl",
    modalContent: "",
    modalBackdrop: "bg-transparent",
    modal: "",
    modalBox: "",
    formButtonPrimary: "bg-white text-black hover:bg-white/90 h-12 text-base",
    headerTitle: "text-white",
    headerSubtitle: "text-white",
    headerTitleText: "text-white",
    headerSubtitleText: "text-white",
    socialButtonsBlockButton: "bg-[#1a1a1a] border border-white/10 text-white hover:bg-[#252525] h-12 text-base",
    socialButtonsBlockButtonText: "text-white text-base",
    formFieldInput: "bg-[#1a1a1a] text-white border-white/10 h-12 text-base px-4",
